    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
      <div className="relative overflow-hidden">
        ...
        <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
          <Button size="sm" variant="ghost" className="bg-white text-gray-600 hover:text-red-500 p-2 rounded-full shadow-md">
            <Heart size={16} />
          </Button>
        </div>
      </div>
      ...
      <div className="p-4">
        <div className="mb-2">
          <Badge variant="outline" className="text-walmart-blue border-walmart-blue">
            {product.brand}
          </Badge>
        </div>
        
        <h3 className="text-sm font-medium text-gray-900 mb-2 line-clamp-2 min-h-[2.5rem]" title={product.productName}>
          {product.productName}
        </h3>
